<script lang="ts">
	...
	// Interface untuk tipe data kartu guru dan staff
	...
	let cards = writable<EmployeeCard[]>([]);

	// Generate random employee data
	function generateRandomData(index: number): EmployeeCard {
		...
		const role = mockData.roles[Math.floor(Math.random() * mockData.roles.length)];
		...
		const nip = '00' + (Math.floor(Math.random() * 90000000) + 10000000).toString();
	...
	function generateQRCode(data: EmployeeCard): string {
		const qrData = `ID:${data.id},NIP:${data.nip},NAMA:${data.name},JABATAN:${data.role}`;
		const typeNumber = 4;
...
<svelte:head>
	<title>ID Card Generator Guru dan Staff MTs Negeri 2 Kolaka Utara</title>
	<!-- Jika menggunakan qrcode-generator via npm, tidak perlu menyertakan script CDN -->
	<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/qrcode-generator/1.4.4/qrcode.min.js"></script> -->
</svelte:head>

<main>
	<h1>ID Card Generator Guru dan Staff MTs Negeri 2 Kolaka Utara</h1>
			...
			<div class="card-pair">
				...
				<div class="id-card id-card-front rounded-lg">
					...
					<div class="card-body">
						<div class="photo-container">
							<img src="https://placehold.co/120x150" alt="Foto Guru dan Staff" />
						</div>

						<div class="employee-info">
							<div class="info-row">
								<div class="info-label">NIP:</div>
								<div class="info-value">{card.nip}</div>
							</div>
							<div class="info-row">
							...
							<div class="info-row">
								...
								<div class="info-value">{card.role}</div>
							</div>
							<div class="info-row">
				...
				<div class="id-card id-card-back">
					<div class="back-header">
						<div class="back-title">KARTU GURU DAN STAFF</div>
						<div class="back-subtitle">MTs NEGERI 2 KOLAKA UTARA</div>
					</div>

					<div class="rules-container">
						<div class="rules-title">TATA TERTIB GURU DAN STAFF</div>
						<ol class="rules-list">
							<li>Guru dan staff wajib menjaga nama baik lembaga.</li>
							<li>Guru dan staff wajib memakai seragam sesuai ketentuan.</li>
							<li>Guru dan staff wajib hadir tepat waktu.</li>
							<li>Dilarang membawa HP ke lembaga.</li>
							<li>Dilarang merokok dan membawa benda tajam.</li>
							<li>Guru dan staff wajib menjaga kebersihan lingkungan.</li>
