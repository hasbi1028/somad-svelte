	...
	P = (t, e, r) =>
		e.has(t)
			...
			: e instanceof WeakSet
				? e.add(t)
				: e.set(t, r),
	C = (t, e, r, n) => (D(t, e, 'write to private field'), n ? n.call(t, r) : e.set(t, r), r);
import {
	e as Z,
	aR as ut,
	g as L,
...
import { p as N } from './BMat-oFk.js';
import { c as W } from './eK_4uKAs.js';
import { g as ht } from './CqkleIqs.js';
import { v as Y } from './D4wBL3Sd.js';
function bt(t) {
	Z(t, t.v + 1);
}
function mt(t) {
...
`,
	...
	B = function (f, v) {
		...
		function x(c) {
			...
			if (s) {
				var m = s[0];
				return M(m), (f = f.slice(m.length)), s;
			}
		}
		function H() {
			x(r);
		...
		function V() {
			...
			if (!(l != f.charAt(0) || p != f.charAt(1))) {
				...
				var m = f.slice(2, s - 2);
				return (y += 2), M(m), (f = f.slice(s)), (y += 2), c({ type: S, comment: m });
			}
		}
		function it() {
			var c = G(),
	...
	for (let r = 1; r < t.length; r++) {
		...
		for (const i in n) {
			...
			if (a && Vt(i)) {
				...
				const l = R(o),
					p = R(u);
				l && p ? (e[i] = W(o, u)) : l ? (e[i] = W(o)) : p && (e[i] = W(u));
			} else if (i === 'style') {
