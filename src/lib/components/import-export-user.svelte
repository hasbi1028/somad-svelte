	...
	<Dialog.Content class="sm:max-w-[425px]">
		...
		<div class="grid gap-4 py-4">
			<div class="flex flex-col gap-4">
				<Input type="file" accept=".csv" onchange={handleFileChange} aria-label="Upload CSV file" />
				<Button variant="outline" onclick={generateCSVTemplate}>Download CSV Template</Button>
			</div>
	...
	<Dialog.Content class="sm:max-w-[425px]">
		...
		<div class="grid gap-4 py-4">
			<div class="flex flex-col gap-4">
				...
				<Button variant="outline" onclick={generateCSVTemplate}>Download Empty Template</Button>
			</div>
		</div>
		<Dialog.Footer>
