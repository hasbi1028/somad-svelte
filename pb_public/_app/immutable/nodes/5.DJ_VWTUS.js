...
import { c as y, f as u, s as t, n as s, r as w, t as se } from '../chunks/DQMf8gWK.js';
import { t as l, a as e, b as o } from '../chunks/BGOrq1ZG.js';
import { s as re, a as Ge } from '../chunks/DvbRtjlS.js';
import { s as fe } from '../chunks/DjKtoK8y.js';
import { B as ee } from '../chunks/DiI5vKnB.js';
import { B as vt, a as pt, b as Ce, c as He, d as We, e as _t } from '../chunks/J8Vpfqcd.js';
import { B as K } from '../chunks/DWr6XhLj.js';
import { C as ce } from '../chunks/CTqa1KBK.js';
import { C as $e, a as ue, b as ve, c as me } from '../chunks/tqNMKigX.js';
import { C as he } from '../chunks/C7FUM4tv.js';
import { R as De, T as je, D as Oe, G as Ye, a as ae } from '../chunks/KMVKlTlO.js';
import { I as ft } from '../chunks/CdbIut2i.js';
import { P as mt, a as ht, b as qe } from '../chunks/C1l7uucW.js';
import { P as Ve, C as xt, T as gt, E as Pt } from '../chunks/BbOFliMM.js';
import { S as xe } from '../chunks/CnGJdrx-.js';
import { R as bt, T as yt } from '../chunks/B30UQf1T.js';
import { T as wt, a as zt, b as X, c as pe, d as kt, e as x } from '../chunks/CAqpGiXc.js';
import { R as St, T as Tt, a as Ae, b as Ct } from '../chunks/DFqNo9BL.js';
import { P as Ke, R as oe, T as le, a as de } from '../chunks/BRCSvknx.js';
import { P as Qe } from '../chunks/Bd-3lPh9.js';
import { S as Dt, D as Xe } from '../chunks/PBI3cEsC.js';
import { C as jt } from '../chunks/q040WeiW.js';
import { C as Ot } from '../chunks/RBZk_sAS.js';
import { C as At } from '../chunks/Duhau3sb.js';
import { H as Ze } from '../chunks/v68N3jfw.js';
import { S as et, P as tt, C as st } from '../chunks/CEA1YfQ0.js';
import { U as rt, S as Bt } from '../chunks/CWiE73gJ.js';
import { S as Rt } from '../chunks/B8S9RRQw.js';
import { P as Ft } from '../chunks/BQKSChen.js';
import { D as ge } from '../chunks/4vG4j1h8.js';
import { D as Be, L as It, F as Lt } from '../chunks/DJyPZ8x_.js';
var Et = l('<a><!> <span class="sr-only">Dashboard</span></a>'),
	Mt = l('<!> <!>', 1),
	Jt = l('<a><!> <span class="sr-only">Orders</span></a>'),
	Nt = l('<!> <!>', 1),
	Ut = l('<a><!> <span class="sr-only">Products</span></a>'),
	Gt = l('<!> <!>', 1),
	Ht = l('<a><!> <span class="sr-only">Customers</span></a>'),
	Wt = l('<!> <!>', 1),
	Yt = l('<a><!> <span class="sr-only">Analytics</span></a>'),
	qt = l('<!> <!>', 1),
	Vt = l('<!> <!> <!> <!> <!>', 1),
	Kt = l('<a><!> <span class="sr-only">Settings</span></a>'),
	Qt = l('<!> <!>', 1),
	...
	ls = l('<!> <!>', 1),
	ds = l('<!> <!>', 1),
	ns = l('<div class="text-muted-foreground text-xs">+25% from last week</div>'),
	is = l('<!> <!> <!>', 1),
	cs = l('<!> <!>', 1),
	$s = l('<div class="text-muted-foreground text-xs">+10% from last month</div>'),
	us = l('<!> <!> <!>', 1),
	vs = l('<!> <!> <!>', 1),
	ps = l('<!> <span class="sr-only sm:not-sr-only">Filter</span>', 1),
	_s = l('<!> <!> <!> <!> <!>', 1),
	fs = l('<!> <!>', 1),
	ms = l('<!> <span class="sr-only sm:not-sr-only">Export</span>', 1),
	hs = l('<!> <!>', 1),
	xs = l('<!> <!> <!> <!> <!>', 1),
	gs = l(
	...
	Ms = l('<!> <span class="sr-only">Copy Order ID</span>', 1),
	Js = l('Order Oe31b70H <!>', 1),
	Ns = l('<!> <span class="lg:sr-only xl:not-sr-only xl:whitespace-nowrap">Track Order</span>', 1),
	Us = l('<!> <span class="sr-only">More</span>', 1),
	Gs = l('<!> <!> <!> <!>', 1),
	Hs = l('<!> <!>', 1),
	Ws = l(
	...
	qs = l('<!> <span class="sr-only">Previous Order</span>', 1),
	Vs = l('<!> <span class="sr-only">Next Order</span>', 1),
	Ks = l('<!> <!>', 1),
	Qs = l(
...
function Ar(at) {
	var Pe = Zs(),
		...
		we = y(ye),
		ot = y(we);
	Qe(ot, { class: 'size-4 transition-all group-hover:scale-110' }), s(2), w(we);
	var lt = t(we, 2);
	Ke(lt, {
		children: (I, Q) => {
			var z = Vt(),
			...
			Rt(C, {
				...
				children: (k, b) => {
					var P = Zt(),
						p = y(P),
						v = y(p);
					Qe(v, { class: 'size-5 transition-all group-hover:scale-110' }), s(2), w(p);
					var $ = t(p, 2),
						d = y($);
					Ze(d, { class: 'size-5' }), s(), w($);
					var c = t($, 2),
						_ = y(c);
					et(_, { class: 'size-5' }), s(), w(c);
					var m = t(c, 2),
						n = y(m);
					tt(n, { class: 'size-5' }), s(), w(m);
					var h = t(m, 2),
						i = y(h);
					rt(i, { class: 'size-5' }), s(), w(h);
					var f = t(h, 2),
						S = y(f);
					st(S, { class: 'size-5' }), s(), w(f), w(P), e(k, P);
				},
				$$slots: { default: !0 }
			}),
				e(I, z);
	...
	var ke = t(Le, 2),
		Ee = y(ke);
	Dt(Ee, { class: 'text-muted-foreground absolute left-2.5 top-2.5 size-4' });
	var nt = t(Ee, 2);
	ft(nt, {
		type: 'search',
		placeholder: 'Search...',
				...
				child: (b, P) => {
					K(
						...
						fe(() => (P == null ? void 0 : P().props), {
							...
							children: (v, $) => {
								var d = ss();
								Ge(d, 'width', 36), Ge(d, 'height', 36), e(v, d);
							},
							$$slots: { default: !0 }
						})
					);
			...
			$e(T, {
				...
				children: (k, b) => {
					...
					ve(v, {
						...
						children: ($, d) => {
							s();
							var c = o(`Introducing Our Dynamic Orders Dashboard for Seamless Management and
								Insightful Analysis.`);
							e($, c);
						},
						$$slots: { default: !0 }
	...
	ce(Ne, {
		...
		children: (I, Q) => {
			...
			he(k, {
				children: (b, P) => {
					Ve(b, { value: 25, 'aria-label': '25% increase' });
				},
				$$slots: { default: !0 }
			}),
				e(I, z);
	...
	ce(ct, {
		...
		children: (I, Q) => {
			...
			he(k, {
				children: (b, P) => {
					Ve(b, { value: 12, 'aria-label': '12% increase' });
				},
				$$slots: { default: !0 }
			}),
				e(I, z);
							...
							$e(m, {
								...
								children: (h, i) => {
									...
									ve(M, {
										children: (D, L) => {
											s();
											var H = o('Recent orders from your store.');
											e(D, H);
										},
										$$slots: { default: !0 }
									}),
			...
			me(C, {
				...
				children: (b, P) => {
					...
					var m = t(_, 2),
						...
						i = y(h),
						f = y(i);
					jt(f, { class: 'size-4' }), s(), w(i), s(2), w(h), w(n), w(m), e(b, p);
				},
				$$slots: { default: !0 }
			});
			var k = t(C, 2);
