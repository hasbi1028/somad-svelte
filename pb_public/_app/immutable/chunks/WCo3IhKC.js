...
import { v as at, c as T, a as f, t as Le } from './D4wBL3Sd.js';
import { c as lt } from './D-TmFHfb.js';
import { p as a, i as B, s as Re, r as We } from './CjIAJ7VA.js';
import { a as dt } from './Bsldq5z3.js';
import { s as K } from './CiWmPosG.js';
import { a as U } from './eK_4uKAs.js';
import { b as l, o as ut, w as je, a as Qe, e as ct, u as Xe, m as le } from './iSg1OsVq.js';
import {
	j as pt,
	C as Ye,
	k as ht,
...
const wt = 'data-tooltip-content',
	...
	$e = new ft('bits.tooltip.open', { bubbles: !1, cancelable: !1 });
var J, M, de, ue;
class _t {
	constructor(e) {
		u(this, 'opts');
...
class Dt {
	constructor(e, r) {
		...
		s(this, we, (e) => {
			t(this, R).current ||
				i(t(this, m)) ||
				(this.root.ignoreNonKeyboardFocus && !ht(e.currentTarget)) ||
...
const et = new Ye('Tooltip.Provider'),
	ze = new Ye('Tooltip.Root');
function Ft(o) {
	return et.set(new _t(o));
}
function kt(o) {
	return ze.set(new Ot(o, et.get()));
}
function Et(o) {
	return new Dt(o, ze.get());
}
function It(o) {
	return new Nt(o, ze.get());
}
function Kt(o, e) {
	Y(e, !0);
	let r = a(e, 'open', 15, !1),
									...
									popper: (re, w) => {
										...
										var _ = C(se);
										{
											var S = (O) => {
													var D = T(),
														ne = C(D),
														z = Ve(() => ({ props: i(P), wrapperProps: ie(), ...h.snippetProps }));
													K(
														ne,
														() => e.child,
														() => i(z)
				...
				Fe = C(ee);
			{
				var ke = (F) => {
					...
					te = (F) => {
						...
						let H;
						var oe = G(h);
						K(oe, () => e.children ?? j), q(h), Ae(() => (H = U(h, H, { ...i(b) }))), f(F, h);
					};
				B(Fe, (F) => {
					e.child ? F(ke) : F(te, !1);
				});
...
const Zt = Kt,
	$t = St,
	eo = Mt;
export { eo as P, Zt as R, $t as T, Yt as a };
