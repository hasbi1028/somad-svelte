...
var Me = (t, e, r) =>
	e in t ? Ne(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r);
...
import { c as pe, a as o, t as x, b as M } from '../chunks/D4wBL3Sd.js';
import { i as me, p as R, r as ze, s as ce } from '../chunks/CjIAJ7VA.js';
import { a as xe, B as Q } from '../chunks/Bsldq5z3.js';
import { C as be } from '../chunks/QDtlYqdc.js';
import { D as Je, C as ke, a as ye, b as we, c as Ce } from '../chunks/CbUYl22c.js';
import { C as Pe } from '../chunks/vYS07VBd.js';
import { c as He } from '../chunks/D-TmFHfb.js';
import { s as $e } from '../chunks/CiWmPosG.js';
import { r as Ke, a as Ae } from '../chunks/eK_4uKAs.js';
import {
	a as Le,
	w as Se,
	s as Ue,
...
import { i as st } from '../chunks/CBZYCnD7.js';
import { V as ot } from '../chunks/YJ0c87i7.js';
import { M as at } from '../chunks/CsBS4j6z.js';
import { C as nt } from '../chunks/CmjqrqP0.js';
import { R as it, T as dt, D as lt, G as ct, a as de } from '../chunks/BOSOt6G1.js';
import { I as le } from '../chunks/C5wd2lyJ.js';
import { R as ut, T as ht } from '../chunks/BvN8JEzU.js';
import { P as De } from '../chunks/Db07kPmK.js';
import { S as ft } from '../chunks/B0otktkl.js';
import { M as pt, C as mt } from '../chunks/CM_3bmqS.js';
import { D as Re } from '../chunks/BX2CG_nZ.js';
const vt = [];
function gt(t, e = !1) {
...
class xt {
	constructor(e, r = null) {
		...
		N(
			...
			z(() => ({
				...
				'aria-checked': tt(this.opts.checked.current, this.opts.indeterminate.current),
				'aria-required': et(this.trueRequired),
				'data-disabled': Ze(this.trueDisabled),
	...
	onkeydown(e) {
		this.opts.disabled.current ||
			(e.key === We && e.preventDefault(),
			e.key === Ye && (e.preventDefault(), ie(this, U, ue).call(this)));
	}
	onclick(e) {
		this.opts.disabled.current || ie(this, U, ue).call(this);
	}
	get snippetProps() {
		return S(j(this, te));
	}
...
var At = x('<!> <span class="sr-only">Toggle navigation menu</span>', 1),
	...
	It = x('<!> <!>', 1),
	Ot = x('<!> <span class="sr-only">Toggle user menu</span>', 1),
	Nt = x('<!> <!> <!> <!> <!> <!>', 1),
	Mt = x('<!> <!>', 1),
	Et = x('<!> <!>', 1),
	jt = x('<form><!></form>'),
...
function gr(t) {
	...
	var k = i(d, 2),
		...
		y = g(A),
		T = g(y);
	ft(T, { class: 'text-muted-foreground absolute left-2.5 top-2.5 size-4' });
	var X = i(T, 2);
	le(X, {
		type: 'search',
			...
			ke(f, {
				children: (m, h) => {
					...
					we(b, {
						children: (p, I) => {
							v();
							var O = M('Used to identify your store in the marketplace.');
							o(p, O);
						},
						$$slots: { default: !0 }
					}),
			...
			ke(f, {
				children: (m, h) => {
					...
					we(b, {
						children: (p, I) => {
							v();
							var O = M('The directory within your project, in which your plugins are located.');
							o(p, O);
						},
						$$slots: { default: !0 }
					}),
