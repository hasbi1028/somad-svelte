    ...
    <div class="flex items-center gap-3">
      ...
      <Breadcrumb.Root>
        <Breadcrumb.List>
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Page>
              <a href="/dashboard/user">Data Siswa</a>
            </Breadcrumb.Page>
          </Breadcrumb.Item>
        </Breadcrumb.List>
      </Breadcrumb.Root>
      ...
      <Tabs.Root value="all">
        <div class="flex items-center">
          <Tabs.List>
            ...
            <Tabs.Trigger value="inactive">Tidak Aktif</Tabs.Trigger>
          </Tabs.List>
          <div class="ml-auto flex items-center gap-2">
            ...
            <Button size="sm" class="h-7 gap-1">
              ...
              <span class="sr-only sm:not-sr-only sm:whitespace-nowrap">Tambah Siswa</span>
            </Button>
          </div>
        </div>
        <Tabs.Content value="all">
          <Card.Root>
            <Card.Header>
              ...
              <Card.Description>
                Kelola data siswa Anda dan lihat informasi mereka.
              </Card.Description>
            </Card.Header>
            <Card.Content>
              <Table.Root>
                <Table.Header>
                  <Table.Row>
                    <Table.Head class="w-[100px] sm:table-cell">Photo</Table.Head>
                ...
                <Table.Body>
                  {#each paginatedUsers as user}
                    <Table.Row>
                      ...
                      <Table.Cell class="font-medium">{user.nisn}</Table.Cell>
