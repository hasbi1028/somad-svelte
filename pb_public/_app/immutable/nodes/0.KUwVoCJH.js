...
import { e as T, a, t as F, n as lt, b as kt } from '../chunks/BGOrq1ZG.js';
import { s as $t } from '../chunks/D3E8oDJG.js';
import '../chunks/q3O7Mc_4.js';
import { p as eo } from '../chunks/OWF93kYu.js';
import {
	s as to,
	d as oo,
	a as Ot,
	...
	m as Nt,
	k as At
} from '../chunks/D9BtlccV.js';
import '../chunks/69_IOA4Y.js';
import { p as s, i as C, l as Tt, b as Dt, s as it, r as fo } from '../chunks/DjKtoK8y.js';
import { i as Ge } from '../chunks/fNOI7Wql.js';
import { a as ct, s as Ee, d as mo } from '../chunks/BNBOt3lZ.js';
import { o as Bt, a as vo } from '../chunks/BFd-cvYk.js';
import { a as x, b as Ye, s as go } from '../chunks/DvbRtjlS.js';
import { h as ho, s as nt } from '../chunks/CPLw4cna.js';
import { h as po } from '../chunks/BpBSPw76.js';
import { e as $ } from '../chunks/BTRVP7y_.js';
import { e as St, i as Ht } from '../chunks/Ds4ehkC6.js';
import { s as pe } from '../chunks/jIU1MAPh.js';
import { a as Lt, u as _o, c as Ze } from '../chunks/Ddp6AEfo.js';
import { c as st } from '../chunks/D7_cnrTr.js';
import { s as qe } from '../chunks/DTL47GPV.js';
function Ce(B, t, l, S) {
...
function Mo(B, t) {
	...
	let A = s(t, 'track', 8, !0),
		...
		W = s(t, 'disableTransitions', 8, !0),
		Y = s(t, 'darkClassNames', 24, () => ['dark']),
		...
		j = s(t, 'disableHeadScriptInjection', 8, !1);
	Bt(() => {
		const q = Ot.subscribe(() => {}),
			Xe = ao.subscribe(() => {});
...
function jo(B, t) {
	...
	d(
		...
		d(
			() => (v(o()), e(h)),
			() => {
				r(Z, (o().promise && e(h) === 'loading') || o().duration === Number.POSITIVE_INFINITY);
			}
		),
		d(
			() => (e(Z), v(Ke()), v(Me()), e(Ae)),
			() => {
				mo(
					r(
						at,
						_o(() => (e(Z) || (Ke() || Me() ? gt() : ot()), () => clearTimeout(e(Ae))))
					),
					'$effect',
					S
				);
	...
	var re = ke(i);
	{
		var ht = (n) => {
			...
			Q(
				(b) => {
					x(c, 'data-disabled', e(X)), qe(c, Ye(b));
				},
				[
					() => {
						var b, I, E;
								...
								D = (L) => {
										...
										Te = g(ie);
									{
										var pt = (je) => {
												var Qe = T(),
													yt = g(Qe);
												pe(yt, t, 'success-icon', {}, null), a(je, Qe);
											},
											_t = (je) => {
												var Qe = T(),
													yt = g(Qe);
												{
													var Yt = (Ve) => {
															var $e = T(),
																wt = g($e);
															pe(wt, t, 'error-icon', {}, null), a(Ve, $e);
														},
														Zt = (Ve) => {
															var $e = T(),
																wt = g($e);
															{
																var qt = (We) => {
																		var et = T(),
																			bt = g(et);
																		pe(bt, t, 'warning-icon', {}, null), a(We, et);
																	},
																	Gt = (We) => {
																		var et = T(),
																			bt = g(et);
					...
					ue = ke(E);
				{
					var Mt = (O) => {
							...
							he = ke(p);
						{
							...
							C(he, (f) => {
								typeof o().title != 'string' ? f(N) : f(G, !1);
							});
						}
						fe(p),
							Q(
				...
				var Ft = Se(ue, 2);
				{
					var Ut = (O) => {
							...
							he = ke(p);
						{
							...
							C(he, (f) => {
								typeof o().description != 'string' ? f(N) : f(G, !1);
							});
						}
						fe(p),
							Q(
				...
				var Pt = Se(E, 2);
				{
					var jt = (O) => {
						...
						fe(p),
							Q(
								(N) => {
									x(p, 'style', ut()), qe(p, Ye(N)), nt(he, o().cancel.label);
								},
								[
									() => {
										var N, G, f;
										return Ze(
											...
											(f = (G = o()) == null ? void 0 : G.classes) == null ? void 0 : f.cancelButton
										);
									}
								],
								V
				...
				var Vt = Se(Pt, 2);
				{
					var Wt = (O) => {
						...
						fe(p),
							Q(
								(N) => {
									x(p, 'style', ft()), qe(p, Ye(N)), nt(he, o().action.label);
								},
								[
									() => {
										var N, G, f;
										return Ze(
											...
											(f = (G = o()) == null ? void 0 : G.classes) == null ? void 0 : f.actionButton
										);
									}
								],
								V
							...
							$('click', p, (N) => {
								var G;
								(G = o().action) == null || G.onClick(N), !N.defaultPrevented && xe();
							}),
							a(O, p);
					};
					C(Vt, (O) => {
...
var Vo = F('<ol></ol>'),
	Wo = F('<section class="svelte-1fo5d1m"></section>');
function Yo(B, t) {
	const l = Tt(t, ['children', '$$slots', '$$events', '$$legacy']),
		S = Tt(l, [
			'invert',
	...
	let X = s(t, 'invert', 8, !1),
		...
		q = s(t, 'richColors', 8, !1),
		Xe = s(t, 'expand', 8, !1),
		He = s(t, 'duration', 8, 4e3),
		Je = s(t, 'visibleToasts', 8, W),
	...
	d(
		...
		d(
			() => v(Z()),
			() => {
				if ((Z() !== 'system' && r(Be, Z()), typeof window < 'u')) {
					Z() === 'system' &&
							...
							Q(
								(R, Ie, ze) => {
									...
									(J = go(
										...
										Ce(P, '--offset', typeof Le() == 'number' ? `${Le()}px` : Le() || Y),
										Ce(P, '--width', `${h}px`),
										Ce(P, '--gap', `${ee}px`),
										(P.dir = P.dir);
								},
...
function Zo(B, t) {
	const [l, S] = ct(),
		_ = () => Ee(Ot, '$mode', l);
	let k = fo(t, ['$$slots', '$$events', '$$legacy']);
	Yo(
		B,
		it(
			{
