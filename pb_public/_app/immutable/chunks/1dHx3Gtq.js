...
var ce;
const P = ((ce = globalThis.__sveltekit_5g1zow) == null ? void 0 : ce.base) ?? '';
var le;
const Qe = ((le = globalThis.__sveltekit_5g1zow) == null ? void 0 : le.assets) ?? P,
	tn = '1739959473950',
...
async function qn(t, e, n) {
	...
	document.URL !== location.href && (location.href = location.href),
		...
		(T = (o = history.state) == null ? void 0 : o[J]),
		R || ((R = T = Date.now()), history.replaceState({ ...history.state, [G]: R, [J]: T }, ''));
	const r = V[R];
		...
		z.add(e),
			(L = {
				...
				promise: Wt({ ...t, preload: e }).then(
					(n) => (z.delete(e), n.type === 'loaded' && n.state.error && (L = null), n)
				)
			});
	}
	return L.promise;
...
async function Wt({ id: t, invalidating: e, url: n, params: r, route: a, preload: s }) {
	if ((L == null ? void 0 : L.id) === t) return z.delete(L.token), L.promise;
		...
		return Ht({
			...
			parent: async () => {
				...
				for (let It = 0; It < v; It += 1)
					Object.assign(zt, (Jt = await S[It]) == null ? void 0 : Jt.data);
				return zt;
			},
			server_data_node: Kt(
...
async function K({
	...
	let h = w && (await Wt(w));
	if (!h) {
		if (bt(e, P, k.hash)) return await q(e);
		h = await Pe(
			e,
			{ id: null },
...
function On() {
	...
	(history.scrollRestoration = 'manual'),
		...
		addEventListener('hashchange', () => {
			H
				? ((H = !1),
					history.replaceState({ ...history.state, [G]: ++R, [J]: T }, '', location.href))
...
export { qn as a, xn as g, Hn as i, I as p, D as s };
