...
<div class="flex flex-1 flex-col gap-4 p-4 pt-0">
	<div class="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min">
		<h1 class="text-4xl font-bold p-4">Selamat datang Admin</h1>
		<p class="text-lg p-4">
			Selamat datang di halaman admin. Anda dapat mengatur berbagai halaman yang ada di dalam
			website ini.
		</p>
		<img src="/favicon.png" alt="Admin" class="w-full max-w-md mx-auto mt-4" />
	</div>
</div>
